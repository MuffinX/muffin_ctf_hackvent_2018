...
AUTH_TOKEN = '25af838be4daaf801e6ec6e14a7953956a48e7ffa95021a5113c31c5d1cd0323'
...
def get_players(service):
    # get players from api
    return do_api_request('api/get_players', {
